...
const filterSelectStyles = {
  control: (styles: any, { isFocused }: any) => ({ ...styles, backgroundColor: 'white', border: '1px solid #E7E7E7' }),
  singleValue: (styles: any) => ({ ...styles, color: '#131340', fontSize: '12px', fontWeight: '500' }),
